...
The canonical source is this repository's skills/branded-lead-funnel-builder directory. Edit it here, test the change, then run the installer. Installed copies and generated client projects are outputs, not the place to make the only copy of a reusable fix.

## Map

| Location | Purpose |
| --- | --- |
| skills/branded-lead-funnel-builder/SKILL.md | Agent's entry point and workflow requirements |
| skills/branded-lead-funnel-builder/references/ | Stage-specific guidance and portable copy library |
| skills/branded-lead-funnel-builder/scripts/ | Research, copy, evidence, PDF/image, scaffold and onboarding helpers |
| skills/branded-lead-funnel-builder/assets/cloudflare/ | Worker, D1 migrations, public/admin assets and application tests copied into generated projects |
| skills/branded-lead-funnel-builder/assets/demo.json | Fictional demo contract and reviewed form selectors |
...
Read the [first-run guide](skills/branded-lead-funnel-builder/references/first-run.md). With Python 3.10+ and Node 24 available:
