...
const agent='01a0c011-8e9b-7f20-9ca4-ee86a77e7cfa';
const transcript=`/Users/mac/.codex/sessions/2026/09/20/rollout-2026-09-20T21-26-11-${agent}.jsonl`;
...
const originals=[];
for(const name of ['hero-original.png','bookkeeping-original.png','deadlines-original.png','consultation-original.png']){
  const sha256=hash(await readFile(new URL(`../../runs/image-generation-r5/project/research-assets/${name}`,import.meta.url)));
  originals.push({file:`research-assets/${name}`,sha256,matchesReturned:returned.find(a=>a.sha256===sha256)?.file||null});
}
