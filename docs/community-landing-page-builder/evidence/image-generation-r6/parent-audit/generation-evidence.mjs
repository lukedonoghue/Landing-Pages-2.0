...
const agent='01a0c029-5bb8-7143-8ca1-d04beafaa8b0';
const transcript=`/Users/mac/.codex/sessions/2026/09/20/rollout-2026-09-20T21-52-11-${agent}.jsonl`;
...
for(const name of ['hero-original.png','bookkeeping-original.png','tax-original.png','consultation-original.png']){
  const sha256=hash(await readFile(new URL(`../../runs/image-generation-r6/project/build/research-assets/${name}`,import.meta.url)));
