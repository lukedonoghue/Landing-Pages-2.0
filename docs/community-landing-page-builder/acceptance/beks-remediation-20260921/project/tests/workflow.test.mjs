...
test('remote setup cannot contact Cloudflare without explicit existing scope or passing workflow gates', t => {
  for (const mode of ['missing-scope','workflow-gate-blocked']) {
    const root=fixture(t);
    const extra=mode==='workflow-gate-blocked'?setupScope(root,false):[];
