...
Include at least four distinct, relevant content images on a complete landing page. Normally plan five to ten, choosing the final number and roles from research and page coverage. Logos, icons, decorative textures and alternate crops of the same picture do not count. Each picture must support its adjacent message; a numerical target never authorizes irrelevant filler or fabricated proof. Follow the image reference if suitable assets cannot be obtained.
