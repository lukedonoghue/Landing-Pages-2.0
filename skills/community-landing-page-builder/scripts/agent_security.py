...
HOME_PATHS = ["~/.landing-pages-publishing", "~/.wrangler", "~/.config/.wrangler", "~/.config/wrangler", "~/Library/Preferences/.wrangler", "~/.ssh", "~/.aws", "~/.config/gcloud"]
