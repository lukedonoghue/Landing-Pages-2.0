...
def write_demo_sources(project):
    ...
    with (project / "public/styles.css").open("a") as output:
        output.write("\n.demo-notice{padding:10px 20px;text-align:center;background:#e1e9db;color:#203c32;font-size:13px}.demo-guide{max-width:900px;margin:0 auto 60px;padding:24px;display:flex;align-items:center;gap:38px}.demo-guide img{width:220px;height:auto;box-shadow:0 8px 28px #0002}@media(max-width:600px){.demo-guide{flex-direction:column;align-items:flex-start}.demo-guide img{width:160px}}@media(max-width:340px){.demo-notice{padding:6px 12px}}\n")
