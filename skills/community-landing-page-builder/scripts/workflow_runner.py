...
BUILD_OUTPUTS=('build/guide.json','build/guide-build.json','build/guide-review.json','build/guide-review-history','build/guide-pages','build/guide-text.txt','build/thank-you.json','build/thank-you-build.json','build/discovery.json','build/review-insights.json','build/testimonial-selection.json','build/reviews','build/strategy-brief.md','build/claim-ledger.md','build/page-copy.md','build/page-copy.json',
