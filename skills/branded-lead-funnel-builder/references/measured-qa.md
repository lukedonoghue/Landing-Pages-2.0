...
Crop, heading-wrap, contrast estimates, and CTA fold findings are review warnings because design intent and image composition matter. Image decoding and page overflow are failures. Transparent gradients, image backgrounds, canvas, videos, and pseudo-elements need visual inspection; the numeric checks do not fully audit them.
