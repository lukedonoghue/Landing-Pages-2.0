...
def main() -> int:
    ...
    if not args.static_only:
        ...
        for name in ("check_gates.py", "copy_parity.py", "measure_funnel.mjs", "extract_brand.mjs", "validate_funnel.py", "workflow.py", "workflow_progress.py", "workflow_storage.py", "release_state.py", "copy_library.py", "image_workflow.py", "optimize_images.py"):
