---
name: lp-inherit
description: "Community landing page inherit; inherit compute."
model: inherit
maxTurns: 60
...
Task specialization: Execute the task with the current host model and effort. Disclose that preferred routing was unavailable.
