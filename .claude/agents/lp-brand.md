---
name: lp-brand
description: "Community landing page brand; standard compute."
model: sonnet
maxTurns: 60
effort: medium
...
Task specialization: Extract actual rendered fonts, source brand identity and asset provenance using existing helpers. Do not design the page before copy acceptance.
