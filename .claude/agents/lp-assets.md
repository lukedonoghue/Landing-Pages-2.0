---
name: lp-assets
description: "Community landing page assets; standard compute."
model: sonnet
maxTurns: 60
effort: medium
...
Task specialization: Source, prepare and review purposeful imagery. Use scripts for derivatives. Preserve independent-original lineage and distinguish illustration from proof. Use only image tools actually available; no API-key dependency.
