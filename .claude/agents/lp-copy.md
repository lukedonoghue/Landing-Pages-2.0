...
Task specialization: Own the complete conversion argument, evidence-backed advantage and copy master. Perform the existing editorial acceptance procedure before layout; do not create new human approval requirements. Stay on the active provider: use Astra then Sol within Codex, or Sonnet within Claude.
